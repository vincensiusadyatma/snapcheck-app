...
<div id="crud-modal" tabindex="-1" aria-hidden="true" class="hidden fixed inset-0 z-[9999] flex items-center justify-center bg-black bg-opacity-50">
  ...
  <div class="flex flex-wrap mt-10">
    @forelse ($rooms as $room)
        <!-- card -->
        <a href="" class="relative bg-white py-6 px-6 rounded-3xl w-full sm:w-64 md:w-1/4 lg:w-1/4 my-6 mx-2 shadow-xl transform transition-transform duration-300 ease-in-out hover:scale-105">
