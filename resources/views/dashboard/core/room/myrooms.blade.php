...
<div class="head-title">
  ...
  <a href="{{ route('show-myrooms-details', ['room' => $room->id]) }}" 
    ...
    <div class="text-white flex items-center absolute rounded-full py-4 px-4 shadow-xl bg-pink-500 dark:bg-pink-600 left-4 -top-6">
        <!-- SVG Icon -->
    ...
    <div class="mt-8 text-gray-900 dark:text-gray-100">
        ...
        <div class="flex space-x-2 text-gray-600 dark:text-gray-400 text-sm">
            <!-- SVG Icon -->
            <p>{{ $room->description }}</p>
        </div>
        
        <div class="border-t-2 mt-10 border-gray-200 dark:border-gray-700"></div>
    ...
    @empty
        ...
        <div class="flex flex-col items-center justify-center w-full h-64 text-center ">
          ...
          <div class="mt-6">
              <a href="{{ route('create-room') }}" class="text-indigo-500 hover:text-indigo-600 font-semibold">
                  Create A New Room
              </a>
          </div>
      </div>
